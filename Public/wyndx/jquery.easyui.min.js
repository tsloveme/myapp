...
},plugins:["panel"],parse:function(_154){
var aa=[];
...
var _15d;
if(opts.shadow){
_15d=_15a.children("div.tabpanel-border-bottom");	
}else{
_15d=_15a.children("div.panel-footer");
}
var _15dm=$('.middle', _15d);
if(_159){
if(_159.width){
...
_15d.width(_15a.width()-(_15d.outerWidth()-_15d.width()));
if(opts.shadow){
	_15dm.width(_15a.width()-(_15d.outerWidth()-_15d.width())-12);	
}else{
_15dm.width(_15a.width()-(_15d.outerWidth()-_15d.width())-10);
}
}else{
_15b.width(_15a.width());
_15c.width(_15a.width());
_15d.width(_15a.width());
if(opts.shadow){
_15dm.width(_15a.width()-12);
}else{
_15dm.width(_15a.width()-10);
}
}
...
if(opts.border && _166.find(">div.panel-footer").length == 0){
$("<div class=\"panel-footer\"><div class=\"left\"></div><div class=\"middle\"></div><div class=\"right\"></div></div>").appendTo(_166);
_166.find(">div.panel-body").css('border-bottom-width', '0');
}
if(opts.iconCls){
...
if(opts.closable){
$("<div style='color:#333333;font-weight:bold'>X</div>").appendTo(tool).bind("click",_168);
}
if(opts.maximizable){
...
if(opts.shadow && _166.find(">div.tabpanel-border-bottom").length == 0){
$("<div class=\"tabpanel-border-bottom\"><div class=\"left\"></div><div class=\"middle\"></div><div class=\"right\"></div></div>").appendTo(_166);
if(!($.browser.msie && $.browser.version < 7)){
$("<div class=\"tabs-right-border\"></div>").appendTo(_166);	
...
var t=$(_1a3);
return {width:(parseInt(_1a3.style.width)||undefined),height:(parseInt(_1a3.style.height)||undefined),left:(parseInt(_1a3.style.left)||undefined),top:(parseInt(_1a3.style.top)||undefined),title:(t.attr("title")||undefined),iconCls:(t.attr("iconCls")||t.attr("icon")),cls:t.attr("cls"),headerCls:t.attr("headerCls"),bodyCls:t.attr("bodyCls"),href:t.attr("href"),shadow:(t.attr("shadow")?t.attr("shadow")=="true":undefined),loadingMessage:(t.attr("loadingMessage")!=undefined?t.attr("loadingMessage"):undefined),cache:(t.attr("cache")?t.attr("cache")=="true":undefined),fit:(t.attr("fit")?t.attr("fit")=="true":undefined),border:(t.attr("border")?t.attr("border")=="true":undefined),noheader:(t.attr("noheader")?t.attr("noheader")=="true":undefined),collapsible:(t.attr("collapsible")?t.attr("collapsible")=="true":undefined),minimizable:(t.attr("minimizable")?t.attr("minimizable")=="true":undefined),maximizable:(t.attr("maximizable")?t.attr("maximizable")=="true":undefined),closable:(t.attr("closable")?t.attr("closable")=="true":undefined),collapsed:(t.attr("collapsed")?t.attr("collapsed")=="true":undefined),minimized:(t.attr("minimized")?t.attr("minimized")=="true":undefined),maximized:(t.attr("maximized")?t.attr("maximized")=="true":undefined),closed:(t.attr("closed")?t.attr("closed")=="true":undefined)};
};
$.fn.panel.defaults={title:null,iconCls:null,width:"auto",height:"auto",left:null,top:null,cls:null,headerCls:null,bodyCls:null,style:{},href:null,cache:true,fit:false,border:true,doSize:true,noheader:false,content:null,collapsible:false,minimizable:false,maximizable:false,closable:false,collapsed:false,minimized:false,maximized:false,closed:false,tools:[],href:null,shadow:false,loadingMessage:"Loading...",onLoad:function(){
...
if(_1af.mask){
_1af.mask.css({display:"block",zIndex:$.fn.window.defaults.zIndex++,height:$(document).height()});
}
if($.browser.msie && $.browser.version < 7){
$("select", ".select-hide").hide();
}
if(_1af.shadow){
...
$.fn.window.height=function(contentHeight){
return contentHeight > $(window).height()-150 ? $(window).height()-50 : contentHeight + 97+6;
};
...
$("<a id='alertClose'></a>").attr("href","javascript:void(0)").attr("class","garybtn").text(_1e2).css("margin-left",10).bind("click",eval(_1e1[_1e2])).appendTo(tb);
}
}
...
pp.panel("body").css("border-bottom-width", "1px");
pp.panel("body").next().remove();
...
_226(_233);
var tbb=$("<div class=\"tabpanel-border-bottom\"><div class=\"left\"></div><div class=\"middle\"></div><div class=\"right\"></div></div>");
var tbbm=$(">div.middle",tbb);
if(opts.border==true){
tbb.appendTo(_233);
$("<div class=\"panel-corner-tl\"></div>").appendTo(_233);
if(!($.browser.msie && $.browser.version < 7)){
$("<div class=\"tabs-right-border\"></div>").appendTo(_233);
}
}
...
if(opts.border==true){
tbb.width(_238-(_235.outerWidth()-_235.width()));
tbbm.width(_238-(_235.outerWidth()-_235.width())-12);
}
}else{
_235.width(_238);
if(opts.border==true){
