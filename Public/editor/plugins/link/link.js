		...
		edit : function() {
			var lang = self.lang(name + '.'),
				html = '<div style="padding:20px;">' +
					...
					'<input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:560px;" /><a href="http://" id="testa" target="_blank">测试链接</a></div>' +
					...
					//linkList 陈堂宋150216
					'<div class="ke-dialog-row">' +
					'<label for="keUrl" style="width:60px;">点击添加</label>' +
					'<div id="SearchResult" style="height:90px; overflow:scroll"></div>'+
